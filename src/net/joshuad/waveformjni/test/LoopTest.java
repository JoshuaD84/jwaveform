...
public class LoopTest {
  ...
  public static void main(String[] args) throws Exception {
    InputStream inputStream = new FileInputStream("organfinale.wav");
    byte[] fh = new byte[44];
    inputStream.read(fh);
    ...
    HWaveOut waveOut = new HWaveOut(audioFormat, nChannels, sampleRate, byteRateCalc,
        blockAlignCalc, bitsPerSample);
